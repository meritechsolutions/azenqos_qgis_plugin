...
azmfp = os.path.join(azq_utils.get_module_path(), "../example_logs/nr_exynos_drive1/354569110588585-18_08_2020-13_54_22.azm")
...
with sqlite3.connect(dbfp) as dbcon:
    ...
    csv_fp = os.path.join(azq_utils.get_module_path(), "test_df.csv")
